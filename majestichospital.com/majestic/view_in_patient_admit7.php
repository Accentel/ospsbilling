...
<tr><td colspan="2"> <h2 align="center" style="font-size:18px;"><b><u>Nurses / Treatment Chart</u></b></h2></td></tr>
  </THEAD></table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="background:#FFFFFF">
  <tr>
	...
	<?php $id=$_REQUEST['patno'];
	 $x="select * from casesheet_nursesrecord where pat_regno='$id'";
...
while($r=mysqli_fetch_array($sql1)){
	...
	$INVG_ITEM_CODE=$r['INVG_ITEM_CODE'];
	$dose=$r['dose'];
	$route=$r['route'];
...
<th><?php echo $INVG_ITEM_CODE?></th>
<th><?php echo $dose?></th>
<th><?php echo $route?></th>
<th><?php echo $Frequency?></th>
<th><?php echo $Special_Proc?></th>
