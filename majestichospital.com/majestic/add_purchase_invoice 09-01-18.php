...
//oCell = document.createElement("TD");
 ...
 oCell = document.createElement("TD");
	 	 oCell.innerHTML = "<div align='center'><input type='text' name='sst"+Row+"' id='sst"+Row+"' class='textbox'  size='3' > </div>"; 
     row.appendChild(oCell);
    ...
    // row.appendChild(oCell);
	  ...
	  oCell = document.createElement("TD");
	 	 oCell.innerHTML = "<div align='center'><input type='text' name='cst"+Row+"' id='cst"+Row+"' class='textbox'  size='3' > </div>"; 
     row.appendChild(oCell);
	// oCell = document.createElement("TD");
