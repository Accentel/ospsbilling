...
<tr height="25px"><TH>S.NO.</TH><TH>UMR No.</TH><TH>PATIENT NAME</TH><TH>ADMISSION DATE</TH><TH>DISCHARGE DATE</TH><TH>EDIT</TH><TH>PRINT</TH></tr>
<?php 
			  include("config.php");
			...
			if($sq){	
             ...
             <?php echo $d?></td>
             <td style="text-align:center;"><a href="delete_discharge.php?id=<?php echo $id?>"><img src="images/edit.gif" /></a><a href="edit_discharge.php?id=<?php echo $id?>"><img src="images/delete.gif" /></a></td>
