 ...
 ?><?php */?>
	<div id="conteneur">
                    ...
                    <tr >
                        ...
                        <td width="60%"  align="left" >
							...
							while($rt=mysqli_fetch_array($r)){ ?>
								<option value="<?php echo $rt['EMP_CODE'] ?>"><?php echo $rt['EMP_NAME'] ?></option>
								<?php		} ?>
                            </select>
                        </td>
                    </tr>            
		...
		<div class="checkcust" align="left" style="margin-top:10px;margin-bottom:10px;margin-left:10px;">
			...
			<input type="checkbox" name="menu[]" value="207" />&nbsp;&nbsp; Change Password<br>
		...
		<input type="checkbox" name="menu[]" value="37" />&nbsp;&nbsp; Create Package<br>
		...
		<div class="checkpur" align="left" style="margin-top:10px;margin-bottom:10px;margin-left:10px;">
            ...
            <input type="checkbox" name="menu[]" value="541" />&nbsp;&nbsp; In Patient Room Shifting<br>
            <input type="checkbox" name="menu[]" value="55" />&nbsp;&nbsp; In Patient Enquiry<br>
             <input type="checkbox" name="menu[]" value="59" />&nbsp;&nbsp; Dischareg Patients<br>
		...
		<div class="checkinv" align="left" style="margin-top:10px;margin-bottom:10px;margin-left:10px;">
            ...
            <input type="checkbox" name="menu[]" value="66" />&nbsp;&nbsp; View  Bill/Pay Balance<br>
			  <input type="checkbox" name="menu[]" value="604" />&nbsp;&nbsp; Hospital Cash Bill<br>
			  <input type="checkbox" name="menu[]" value="605" />&nbsp;&nbsp; Hospital Cash Bill View<br>
			  ...
			  <input type="checkbox" name="menu[]" value="607" />&nbsp;&nbsp; General Cash  Bill View<br>
			   <input type="checkbox" name="menu[]" value="608" />&nbsp;&nbsp; Package Extra Service Bill<br>
			  <input type="checkbox" name="menu[]" value="609" />&nbsp;&nbsp; Package Extra Service Bill View<br>
		...
		<div class="checkinv" align="left" style="margin-top:10px;margin-bottom:10px;margin-left:10px;">
			...
			<input type="checkbox" name="menu[]" value="108" />&nbsp;&nbsp; Discharge Summary Entry<br>
			menu108
		...
		<div class="checkinv" align="left" style="margin-top:10px;margin-bottom:10px;margin-left:10px;">
            ...
            <input type="checkbox" name="menu[]" value="1301" />&nbsp;&nbsp; <B>D.A.C</B><br>
			<input type="checkbox" name="menu[]" value="1298" />&nbsp;&nbsp; <B>Daily Amount Collection</B><br>
			<input type="checkbox" name="menu[]" value="1300" />&nbsp;&nbsp; <B>Daily Amount Pharmacy</B><br>
            <input type="checkbox" name="menu[]" value="1299" />&nbsp;&nbsp; <B>Day Amount Collection Summary</B><br>
