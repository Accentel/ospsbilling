...
include("config.php");
$lr_id=$_REQUEST['id'];
$sql = mysqli_query($link,"select a.suppl_code,b.suppl_name,b.addr1,pur_type,suppl_inv_no,inv_date,rec_by,total,rec_date,grn,b.city,lr_no from phr_purinv_mast as a,phr_supplier_mast as b where lr_no='$lr_id' and a.suppl_code=b.suppl_code")or die(mysqli_error($link));
if($sql){
...
$sql1 = mysqli_query($link,"select product_code,product_name,packing_type,batch_no,mrp,exp_date,s_qty,s_free,s_rate,discount,value,vat,vat_amt,mfg_date,noitems,cost,manu_by,inv_id,sgst,cgst,HSN from phr_purinv_dtl where lr_no='$lr_id'")or die(mysqli_error($link));
		...
		<div id="centre" style="height:auto;">
          ...
          <table width="100%" class="" border="0" cellspacing="5" cellpadding="2">
              <tr>
                ...
                <td  align="left">
				<input name="supcode" type="text" required="required" value="<?php echo $suppl_code ?>" class="text"  onclick="window.open('purchase_inv_popup.php','mypatwindow','width=500,height=500,toolbar=no,resizable=yes,menubar=no,scrollbar=yes')" id="supcode"/>
				</td>
              
                <td width="23%" class="label1"><div align="right">Supplier Name<span class="style2">*</span>:</div></td>
                <td  align="left">
				<input name="supname" type="text" value="<?php echo $suppl_name ?>" required="required" class="text" id="supname" readonly/>
				</td>
              </tr>
			    <tr>
			      <td class="label1"><div align="right">Address:</div></td>
			      <td align="left">
				  <textarea name="addr"  id="addr"  class="text" readonly ><?php echo $address ?></textarea>
				  </td>
			      <td class="label1"><div align="right">GRN NO:</div></td>
			      <td align="left">
				  <input name="grnno" type="text" class="text" id="grnno" value="<?php echo $gr_no ?>" />
				  </td>
			    </tr>
			    <tr>
			      <td class="label1"><div align="right">City:</div></td>
			      <td align="left">
				  <input name="city" type="text" value="<?php echo $city ?>" class="text" id="city" readonly="readonly"/>
				  </td>
                  <td class="label1"><div align="right">Invoice No<span class="style2">*</span>:</div></td>
                  <td align="left">
				  <input name="invno" type="text" value="<?php echo $invno ?>" required="required" class="text" id="invno" />
				  </td>
			    </tr>
				<tr>
				  ...
				  <select name="ptype"  class="text" onchange='CheckColors(this.value);'>
				  ...
				  <input name="invdate" type="date" class="text" id="invdate" value="<?php echo $invdt ?>"/>
				...
				<tr>
				<td> <input name="date3" type="date" class="text" id="date3" value="<?php echo date('Y-m-d'); ?>" /></td>
				</tr>
				</table>
				</div></td>
				  <td class="label1"><div align="right">Received Date<span class="style2">*</span>:</div></td>
				  <td><div align="left">
                      <input name="recdate" type="date" class="text" id="recdate" value="<?php echo $recdt ?>"/>
                  </div>
				  </td>
				</tr>
  ...
  <!-- <th width="7%" class="TH1">P.Code</th>-->
   ...
   <tbody>
    <?php
		...
		<!--<td class="TD1"><input type="text" name="mfgdate[]" value="<?php echo date("d-m-Y"); ?>" id="mfgdate1" size="10"/></td>-->
		...
		<td class="TD1"><input type="text" name="HSN[]" value="<?php echo $HSN ?>" id="HSN1" size="6"/></td>
		...
		<td class="TD1"><input type="text" name="expdate[]" value="<?php echo date("m-Y"); ?>" id="expdate10" size="10"/></td>
		...
		<td class="TD1"><input type="text" name="HSN[]" value="" id="HSN10" size="6"/></td>
		...
		<td class="TD1"><input type="text" name="expdate[]" value="<?php echo date("m-Y"); ?>" id="expdate11" size="10"/></td>
		...
		<input type="hidden" name="vatamt[]" value="" id="vatamt10" size="6"/>
		<input  type="hidden" name="invid[]" id="invid1" class="textbox" value="" size="5" readonly>
		<td class="TD1"><input type="text" name="HSN[]" value="" id="HSN11" size="6"/>
		</td>
		...
		<td class="TD1"><input type="text" name="expdate[]" value="<?php echo date("m-Y"); ?>" id="expdate12" size="10"/></td>
		...
		<input type="hidden" name="vatamt[]" value="" id="vatamt10" size="6"/>
		<input  type="hidden" name="invid[]" id="invid1" class="textbox" value="" size="5" readonly>
		<td class="TD1"><input type="text" name="HSN[]" value="" id="HSN12" size="6"/>
		</td>
		...
		<td class="TD1"><input type="text" name="expdate[]" value="<?php echo date("m-Y"); ?>" id="expdate13" size="10"/></td>
		...
		<input type="hidden" name="vatamt[]" value="" id="vatamt10" size="6"/>
		<input  type="hidden" name="invid[]" id="invid1" class="textbox" value="" size="5" readonly>
		<td class="TD1"><input type="text" name="HSN[]" value="" id="HSN13" size="6"/>
		</td>
		...
		<td class="TD1"><input type="text" name="expdate[]" value="<?php echo date("m-Y"); ?>" id="expdate14" size="10"/></td>
		...
		<input type="hidden" name="vatamt[]" value="" id="vatamt10" size="6"/>
		<input  type="hidden" name="invid[]" id="invid1" class="textbox" value="" size="5" readonly>
		<td class="TD1"><input type="text" name="HSN[]" value="" id="HSN14" size="6"/>
		</td>
...
<table width="100%" >
              	   ...
              	   <td width="19%" align="left"><input type="text" name="total" value="<?php echo ($total)-$vatadd;  ?>" id="total"/></td></tr>
				   <tr>
				   ...
				   <td class="label1">HSN: </td>
              	   <td align="left"><input type="text" name="HSN" value="<?php echo $HSN?>" id="HSN"/></td>
            	   </tr>
              	 <tr>
                   <td colspan="5" class="label1">Net PAYABLE:</td>
              	   <td align="left"><input type="text" name="nettot" value="<?php echo $total ?>" id="nettot"/></td>
              	 </tr>
