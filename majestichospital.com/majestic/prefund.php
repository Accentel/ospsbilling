 ...
 $(document).on('click', '.print-type10', function(){
	...
	?>
          ...
          <h1 style="color:red;" align="center">Package Refund Amount</h1>
           ...
           <form name="form" method="post" action="insert_prefund.php">
...
<td width="10%"><input type="text" required="required" name="patno" class="text" id="patno" width="90%"  "/>
...
<td><input type="text" required="required" name="fname" id="relation" class="text"  /></td>
</tr>

<tr>
<td class="label1">Age <font color="red">*</font> : </td>
<td><input type="text" name="age" id="age" required="required"  class="text"  />


</td>
<td class="label1">Sex <font color="red">*</font> : </td>
<td><input type="text" name="sex" required="required" id="sex" class="text"   /></td>
</tr>
...
<td><input type="text" name="packagename" id="packagename" class="text"  /></td>
<td class="label1">Phone No : </td>
<td><input type="text" name="phone" id="phone" class="text"  /></td>
</tr>
<!--<tr>
...
<td class="label1">Consultant Name</td><td><textarea name="doctor" id="doctor" cols="34" rows="4"/></textarea></td>
</tr>
...
<td>Package Total</td>
<td><input type="text" name="ptotal" id="ptotal" /></td>
</tr>
<tr>

<td>Extra Service </td>
<td><input type="text" name="etotal" id="total"  /></td>
</tr>

<tr>

<td>Net Total</td>
<td><input type="text" name="ntotal" id="ntotal"  /></td>
</tr>
<tr>
