...
$url ="http://sms.scubedigi.com/api.php?username=Durgahospital&password=admin123&to=$to1&from=DHSHUZ&message=".urlencode($msg); 
$ret = file($url); 
...
//$msg="YOUR PATIENT $pname GOT ADMITTED. $time AND $d.  UNDER $doctorname. FURTHER DETAILS WE WILL UPDATE. WE WILL HAPPY FOR UR SUPPORT";
$url1 ="http://sms.scubedigi.com/api.php?username=Durgahospital&password=admin123&to=$mobile&from=DHSHUZ&message=".urlencode($msg1); 
$ret = file($url1);
