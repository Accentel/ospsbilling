...
if($docname != "" and $did!=''){
$sql1 = mysql_query("update manual_doctor_visit set fid='$billno', docname='$docname', visits='$days1', amount='$amount1', total='$total1' where id='$did'");
}
...
if($days != "" and $fid!=''){
$sql2 = mysql_query("update manual_other_desc set fid='$billno', description='$tname', days='$days', amount='$cost', total='$amnt' where id='$fid'");
}
...
if($rs)
{
	...
	print "self.location='manual_bill.php'";
	print "</script>";
}
}
?>