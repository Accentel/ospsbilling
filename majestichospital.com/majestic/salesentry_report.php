...
return xmlHttp;
	...
	<div id="conteneur">
		  ...
		  <?php /*?><div id="header"><?php include("title.php"); ?><b id="logout">Welcome to <?php echo $_SESSION['name1']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="logout.php">Logout</a></b></div><?php */?>
			...
			?>
		  <div id="centre">
          <h1 style="color:red;" align="center">DAY-SALES REPORT</h1>
          ...
          <td><input type="text" name="fdate" id="fdate" style="height:26px;padding-left:5px;" value="<?php echo $today = date("m/d/Y"); ?>" class="tcal"/></td>
          </tr>
