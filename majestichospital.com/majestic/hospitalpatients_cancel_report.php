...
function reportxx(){
	...
	window.open('total_hospitalpatients1.php?sdate='+fdate+'&edate='+tdate,'Mywindow','width=1020,height=800,toolbar=no,menubar=no');
}
</script>	
	</head>
	...
	<div id="conteneur">
			...
			<div id="centre" >
					<div align="center" style="font-size:20px;color:red;font-weight:bold;margin-bottom:20px;">Hospital Canceled Patients Report</div>
