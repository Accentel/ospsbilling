...
function report()
{
   if (document.form.fromdate.value == "") {
	...
	if (document.form.todate.value == "") {
	  ...
	  window.open('da_collected.php?s_date='+s_date+'&e_date='+e_date,'mywindow1','width=1020,height=700,toolbar=no,menubar=no')
	...
	<div id="conteneur container">
		...
		include("logo.php");
		 ...
		 <div id="centre" class="table-responsive" style="height:auto; min-height:450px;">
          <h1 style="color:red;" align="center">OUT PATIENT DOCTOR REPORT</h1>
          ...
          <td>
             ...
             <input name="fromdate" class="text" type="date"  value="<?php echo $today = date("Y-m-d"); ?>"  id="fromdate"/>
              </td>
          </tr>
          <tr height="30px">
          ...
          <td>
              ...
              <input type="date" name="todate" id="todate"  value="<?php echo $today = date("Y-m-d"); ?>" class="text"/>
              </td>
          </tr>
