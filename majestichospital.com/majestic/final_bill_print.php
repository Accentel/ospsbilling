...
<div align="center" style="border:#CC6666">
          ...
          <input type="button" value="Print" id="prnt" class="styled-button-2" onclick="prnt();"/> <a href="final_bill.php"><input type="button" value="Close" id="cls" class="styled-button-2" onclick="closew();"/></a>
								</div>
<div class="book">
    <div class="page">
        <div class="subpage">
...
include("config.php");
$id=$_GET['id'];
$k="select * from  final_bill where  BILL_NO='$id'";
...
<h3 align="center">Final Bill</h3>
        ...
        <th>Amount</th>
         ...
         <?php
					   $p="select * from final_other_desc where fid='$id' ";
       ...
       <tr>
        ...
        <th>Total</th>
         ...
         <?php
					   $p="select * from final_doctor_visit where fid='$id' ";
					  $result=mysqli_query($link,$p) or die(mysqli_error());
					  $i=1;
					   while($r=mysqli_fetch_array($result)){
						   $docname1=$r['docname'];
        ...
        <th>:</th>
        <th class="text"><?php echo $hospaid; ?></th>
        <th>Total Due Amount</th>
        <th>:</th>
        <th class="text"><?php echo $hospdue; ?></th>
        </tr>
        <tr>
        ...
        <th>:</th>
        <th class="text"><?php echo $labpaid; ?></th>
         <th>Total Due Amount</th>
        <th>:</th>
        <th class="text"><?php echo $labdue; ?></th>
        </tr>
         <tr>
        ...
        <th class="text"><?php echo $totpharmacy; ?></th>
         <th>Total Paid Amount</th>
        <th>:</th>
        <th class="text"><?php echo $pharmacypaid; ?></th>
         <th>Total Due Amount</th>
        <th>:</th>
        <th class="text"><?php echo $pharmacydue; ?></th>
        </tr>
        <tr>
        <td colspan="3"><hr/></td>
        </tr>
        ...
        <th class="text">Total Paid Amount</th>
        <th>:</th>
        <th class="text"><?php echo $totpaid; ?></th>
        <th>Total Out Standing Due</th>
        <th>:</th>
        <th class="text"><?php echo $totdue; ?></th>
        </tr>
        <tr>
