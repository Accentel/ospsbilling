...
rows="2";
  ...
  //
	...
	oCell = document.createElement("TD");
	oCell.innerHTML = "<div id='date"+actb5+"'><input type='text' name='date[]' class='textbox1' id='date"+actb5+"' style='width:90px' value='<?php echo date('Y-m-d') ?>' ></div>"; 
    row.appendChild(oCell);
	
	oCell = document.createElement("TD");
	oCell.innerHTML = "<div id='time"+actb5+"'><input type='text' name='time[]' class='textbox1' id='time"+actb5+"' style='width:90px' value='<?php echo date('h:i') ?>' ></div>"; 
    row.appendChild(oCell);
	
	oCell = document.createElement("TD");
oCell.innerHTML = "<input type='text'  name='type[]' id='type"+actb5+"'  class='textbox1' style='width:90px'  >"; 
    row.appendChild(oCell);
    
    oCell = document.createElement("TD");
	oCell.innerHTML = "<input type=text name='name[]' id='name"+actb5+"' style='width:130px' class='textbox1'   ><input type='hidden' name='id2[]' id='id2' value=''/>"; 
    row.appendChild(oCell);
	
	oCell = document.createElement("TD");
oCell.innerHTML = "<input type='text'  name='qty[]' id='qty"+actb5+"'  class='textbox1' style='width:90px'  >"; 
    row.appendChild(oCell);
	
	oCell = document.createElement("TD");
oCell.innerHTML = "<input type='text'  name='dose[]' id='dose"+actb5+"'  class='textbox1' style='width:90px'  >"; 
    row.appendChild(oCell);
	
	oCell = document.createElement("TD");
oCell.innerHTML = "<input type='text'  name='ivim[]' id='ivim"+actb5+"'  class='textbox1' style='width:90px'  >"; 
    row.appendChild(oCell);

	oCell = document.createElement("TD");
oCell.innerHTML = "<input type='text'  name='morning[]' id='morning"+actb5+"'  class='textbox1' style='width:90px'  >"; 
    row.appendChild(oCell);
	oCell = document.createElement("TD");
oCell.innerHTML = "<input type='text'  name='sign[]' id='sign"+actb5+"'  class='textbox1' style='width:90px'  >"; 
    row.appendChild(oCell);
	
	oCell = document.createElement("TD");
oCell.innerHTML = "<input type='text'  name='afternoon[]' id='afternoon"+actb5+"'  class='textbox1' style='width:90px'  >"; 
    row.appendChild(oCell);
	
	oCell = document.createElement("TD");
oCell.innerHTML = "<input type='text'  name='sign1[]' id='sign1"+actb5+"'  class='textbox1' style='width:90px'  >"; 
    row.appendChild(oCell);
	
	oCell = document.createElement("TD");
oCell.innerHTML = "<input type='text'  name='evening[]' id='evening"+actb5+"'  class='textbox1' style='width:90px'  >"; 
    row.appendChild(oCell);
	
	oCell = document.createElement("TD");
oCell.innerHTML = "<input type='text'  name='sign2[]' id='sign2"+actb5+"'  class='textbox1' style='width:90px'  >"; 
    row.appendChild(oCell);
	
	oCell = document.createElement("TD");
oCell.innerHTML = "<input type='text'  name='signature[]' id='signature"+actb5+"'  class='textbox1' style='width:90px'  >"; 
    row.appendChild(oCell);
	...
	<div id="centre" style="height:auto;">
          <h1 style="color:red;" align="center">ADD PHARMACY CARD</h1>
			<form action="pharmacycard_insert.php" name="form" method="post" autocomplete="off" enctype="multipart/form-data">
					...
					<table  width="80%"  style="margin-left:80px;" border="0" cellpadding="4" cellspacing="10">
                        ...
                        <tr>
                         ...
                         <th rowspan="2">Time </th>
                           <th rowspan="2">Tab/Syp/<br/>Inj </th>
                            <th rowspan="2">Drug Name </th>
                             <th rowspan="2">Qty </th>
                         <th rowspan="2">Dose</th>
                         <th rowspan="2">IV/IM/<br/>SC/PO/RT</th>
                         <th colspan="6">Timings</th>
                         ...
                         <?php 
						$p1="select * from pharmacycard where mrno='$mrno' ";
					  $result1=mysql_query($p1) or die(mysql_error());
                       ...
                       <td><input type="text" style='width:90px' name="date[]" id="date" value="<?php echo $r1['date'] ?>"/></td>
                        <td><input type="text" style='width:90px' name="time[]" id="time" value="<?php echo $r1['time'] ?>"/></td>
					   <td ><input type="text" style='width:90px' name="type[]" id="type" value="<?php echo $r1['type'] ?>" ></td>
                       <td ><input type="text" style='width:130px' name="name[]" id="name" value="<?php echo $r1['name'] ?>"/>
                       <input type="hidden" name="id2[]" id="id2" value="<?php echo $r1['id'] ?>"/></td>
			  <td ><input type="text" style='width:90px' name="qty[]" id="qty" value="<?php echo $r1['qty'] ?>" ></td>
              <td ><input type="text" style='width:90px' name="dose[]" id="dose" value="<?php echo $r1['dose'] ?>" ></td>
                            <td ><input type="text" style='width:90px' name="ivim[]" id="ivim" value="<?php echo $r1['ivim'] ?>" ></td>
                              <td ><input type="text" style='width:90px' name="morning[]" id="morning" value="<?php echo $r1['morning'] ?>" ></td>
                                <td ><input type="text" style='width:90px' name="sign[]" id="sign" value="<?php echo $r1['sign'] ?>" ></td>
                             
                              <td ><input type="text" style='width:90px' name="afternoon[]" id="afternoon" value="<?php echo $r1['afternoon'] ?>" ></td>
                                <td ><input type="text" style='width:90px' name="sign1[]" id="sign1" value="<?php echo $r1['sign1'] ?>" ></td>
						 <td ><input type="text" style='width:90px' name="evening[]" id="evening" value="<?php echo $r1['evening'] ?>" ></td>
                                <td ><input type="text" style='width:90px' name="sign2[]" id="sign2" value="<?php echo $r1['sign2'] ?>" ></td>
                                <td ><input type="text" style='width:90px' name="signature[]" id="signature" value="<?php echo $r1['signature'] ?>" ></td>
						</tr>
                        <?php
