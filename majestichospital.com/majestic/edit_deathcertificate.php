...
$sq="update  deathcertificate set mrno='$mrno',pname='$pname',age='$age',fname='$fname',admitdate='$fdate',expdate='$tdate',time='$time',user='$user',cdate=now(),suffer='$suffer' where id='$eid'";
mysqli_query($link,$sq) or die(mysqli_error($link)); 
$id=mysqli_insert_id();
if($sq){
print "<script>";
			print "alert('Successfully Added ');";
			print "self.location='view_deathcertificate.php';";
			print "</script>";
...
mysqli_error();
	...
	$id=$_REQUEST['id'];
$k=mysqli_query($link,"select * from deathcertificate where id='$id'") or die(mysqli_error($link));
