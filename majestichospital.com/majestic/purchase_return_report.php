   ...
   if (document.form.fromdate.value == "") {
	...
	<div id="conteneur">
		 ...
		 <?php /*?> <div id="header"><?php include("title.php"); ?><b id="logout">Welcome to <?php echo $_SESSION['name1']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="logout.php">Logout</a></b></div><?php */?>
			...
			?>
		  <div id="centre">
          <h1 style="color:red;" align="center">PURCHASE RETURN REPORT</h1>
          ...
          <td><input name="fromdate" class="tcal" type="text" style="height:26px;padding-left:5px;" value="<?php echo $today = date("m/d/Y"); ?>"  id="fromdate"/></td>
          </tr>
          <tr height="30px">
          <td class="label1">To Date:</td>
          <td><input type="text" name="todate" id="todate" style="height:26px;padding-left:5px;" value="<?php echo $today = date("m/d/Y"); ?>" class="tcal"/></td>
          </tr>
