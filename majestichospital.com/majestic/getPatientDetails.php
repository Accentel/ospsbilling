...
echo $x="select a.age,a.gender,b.dname1,a.registerno from patientregister as a,doct_infor as b, ip_pat_admit as d 
where d.pat_no='$pname' and d.doc_code=b.id and a.registerno=d.pat_regno";
