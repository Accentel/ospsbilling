...
$lr_id=$_REQUEST['lr_id'];
	...
	$result = mysqli_query($link,"select a.suppl_code,b.suppl_name,b.addr1,pur_type,suppl_inv_no,inv_date,rec_by,total,rec_date,grn,b.city,lr_no from phr_purinv_mast as a,phr_supplier_mast as b where lr_no='$lr_id' and a.suppl_code=b.suppl_code")or die(mysqli_error($link));
while($row = mysqli_fetch_array($result))
 ...
 $sql1 = mysqli_query($link,"select product_code,product_name,packing_type,batch_no,mrp,exp_date,s_qty,s_free,s_rate,discount,value,vat,vat_amt,mfg_date,noitems,cost,manu_by,sgst,cgst from phr_purinv_dtl where lr_no='$lr_id'")or die(mysqli_error($link));
