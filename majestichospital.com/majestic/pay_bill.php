...
//alert(Row);
    ...
    oCell.innerHTML= "<div align='center' ><input  type='text' class='text' name='tname[]' id='cname"+Row+"' /><datalist id='labtestnames' >
</datalist></div>"; 
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
   ...
   // document.getElementById("country5").innerHTML=xmlhttp.responseText;
	...
	var show=xmlhttp.responseText;
	//alert(show);
	document.getElementById("labtestnames").innerHTML=show;
	//document.location.reload();
    }
  }
xmlhttp.open("GET","loadlabtests.php",true);
xmlhttp.send();
}
...
<?php } } ?>
					...
					<table width="100%" id="TABLE1">
					  <thead>
					   ...
					   <tr>
					   <td ><input type="text" class="text cname1" name="tname[]" list="labtestnames" id="cname1" onfocus="showHint21(this.value);" onchange="showHint21(this.value);" required/> <datalist id="labtestnames" >
</datalist></td>
						<td ><input type="text" class="text " name="cost[]" id="cost1"   class="txt"/></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text cname2" name="tname[]"  list="labtestnames" id="cname2" onfocus="showHint22(this.value);"  onchange="showHint22(this.value);" />
					   <datalist id="labtestnames" >
</datalist></td>
						<td ><input type="text" class="text " name="cost[]" id="cost2"   class="txt"/></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text cname3" name="tname[]"  list="labtestnames" id="cname3" onfocus="showHint23(this.value);" onchange="showHint23(this.value);"/>
					   <datalist id="labtestnames" >
</datalist></td>
						...
						<tr>
					   <td ><input type="text" class="text cname4" name="tname[]"  list="labtestnames" id="cname4" onfocus="showHint24(this.value);" onchange="showHint24(this.value);"/>
					   <datalist id="labtestnames" >
</datalist></td>
						...
						<tr>
					   <td ><input type="text" class="text cname5" name="tname[]" list="labtestnames" id="cname5" onfocus="showHint25(this.value);" onchange="showHint25(this.value);"/>
					   <datalist id="labtestnames" >
</datalist></td>
						...
						<tr>
					   <td ><input type="text" class="text cname6" name="tname[]" list="labtestnames" id="cname6" onfocus="showHint26(this.value);" onchange="showHint26(this.value);"/>
					   <datalist id="labtestnames" >
</datalist></td>
						<td ><input type="text" class="text" name="cost[]" list="labtestnames" id="cost6" readonly /></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text cname7" list="labtestnames" name="tname[]" id="cname7" onfocus="showHint27(this.value);" onchange="showHint27(this.value);"/>
					   <datalist id="labtestnames" >
</datalist></td>
						...
						<tr>
					   <td ><input type="text" class="text cname8" list="labtestnames" name="tname[]" id="cname8" onfocus="showHint28(this.value);" onchange="showHint28(this.value);" />
					   <datalist id="labtestnames" >
</datalist></td>
						...
						<tr>
					   <td ><input type="text" class="text cname9" list="labtestnames" name="tname[]" id="cname9" onfocus="showHint29(this.value);" onchange="showHint29(this.value);"/>
					   <datalist id="labtestnames" >
</datalist></td>
						...
						<tr>
					   <td ><input type="text" class="text cname10"  list="labtestnames" name="tname[]" id="cname10" onfocus="showHint30(this.value);" onchange="showHint30(this.value);"/>
					   <datalist id="labtestnames" >
</datalist></td>
