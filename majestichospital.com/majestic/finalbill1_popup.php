...
//opener.document.getElementById("gendays").value=strar[16];
			 opener.document.getElementById("labtot").value=strar[17];
			  opener.document.getElementById("labpaid").value=strar[18];
			   opener.document.getElementById("labdue").value=strar[19];
			opener.document.getElementById("hosppaid").value=strar[20];
			opener.document.getElementById("hospdue").value=strar[20];
			
			opener.document.getElementById("pharmacytot").value=strar[21];
			   opener.document.getElementById("pharmacypaid").value=strar[21];
			opener.document.getElementById("pharmacydue").value=strar[22];	
