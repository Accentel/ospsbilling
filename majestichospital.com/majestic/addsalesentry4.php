...

{
	...
	$rsp=mysqli_query($link,"select distinct product_name,HSN from phr_purinv_dtl where balance_qty>0")or die(mysqli_error($link));
...
{ 
	...
	{ 	var str=document.form.str.value
	    ...
	    document.getElementById("batchdiv"+str).innerHTML=showdata;
		 ...
		 document.getElementById("HSN"+str).value;
	}
}
	...
	{ 
		...
		document.getElementById("bal"+str).value=strar[1];
			 ...
			 // document.getElementById("pcode"+str).value=strar[5];
			  ...
			  document.getElementById("HSN"+str).value=strar[18];
