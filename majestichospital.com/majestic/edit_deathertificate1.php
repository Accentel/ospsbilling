...
$mr=$_GET['id'];
$sq=mysqli_query($link,"select * from `form4` where id='$mr'")or die(mysqli_error($link));
...
.text-line {
    ...
    padding: 3px 10px;
          ...
          <h1 style="color:red;" align="center">EDIT MEDICAL CERTIFICATE OF CAUSE OF DEATH </h1>
