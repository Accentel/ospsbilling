...
<input type="hidden" name="authby" value="<?php echo $aname ?>"/>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <?php 
		$k=mysqli_query($link,"select * from tariff") or die(mysqli_error($link));
        ...
        <td><input type="text" name="amnt[]" id="amnt<?php echo $i; ?>" value="" size="10" class="txt" readonly="readonly"/></td>
        </tr>
        <?php $i++; } ?>
