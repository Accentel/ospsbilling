...
<tr><td width="68" class="label1"><a href="add_blood.php" title="Add New Record"><img src="images/add1.gif"></a></td></tr>
</table>
...
<?php 
            ...
            <!-- <td><?php echo $arrival_mode;?></td><td><?php echo $ref_from;?></td>-->
             <td style="text-align:center;"><a href="edit_blood.php?id=<?php echo $rid?>"><img src="images/edit.gif" /></a></td><!--<td style="text-align:center;"><A onclick="card_pop('<?php echo $advid ?>')">
				 <img src="images/view.gif"></A>--></td></tr>
             <?php }$i++;}
			 }
			 }
			 else{
				  $q="select k1.id,M.reg_id,A.PAT_REGNO,A.ADMIT_DATE,M.patientname,M.arrival_mode,k.ref_docname,M.age,M.gender
				 from ip_pat_admit as A,patientregister as M,referal_doctor as k,`blood_comp1` k1 WHERE  A.PAT_REGNO=M.registerno and dis_status not like
				  'Discharged' and M.ref_doc=k.refcode and k1.mrno=M.registerno order by reg_id desc";
           ...
           <!--  <td><?php echo $arrival_mode;?></td><td><?php echo $ref_from;?></td></td>-->
             <td style="text-align:center;"><a href="edit_blood.php?id=<?php echo $kid?>"><img src="images/edit.gif" /></a></td><!--<td style="text-align:center;">-->
