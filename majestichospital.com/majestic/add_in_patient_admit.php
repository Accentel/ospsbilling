...
<tr><td colspan="2" class="label1" align="left">Without Package &nbsp;&nbsp;<input type="radio" checked="checked" value="No" name="pkg_type" />&nbsp;&nbsp;&nbsp;&nbsp;Package &nbsp;&nbsp;<input type="radio" onclick="javascript:location.href='add_in_patient_admit1.php'" name="pkg_type" /></td></tr>
...
<td>
 <select name="room_type" id="room_type"  class="text" onchange="showHint2k(this.value)" required>
  <option value=""> -- Select -- </option>
  <?php
	include("config.php");
...
<tr>
  ...
  <select name="bedsno" id="bedsno" class="text" onchange="showHint2(this.value)" required>
...
<!--<td class="label1" >Room Rent</td>             
    <td><input name="roomrents" type="text" class="text"  id="roomrents"  size="8" /></td>-->
</tr>
          <!--  <tr>
