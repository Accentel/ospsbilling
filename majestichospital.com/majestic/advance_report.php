...
//	$roomno = $row['room_no'];
	...
	$x="select a.PAT_REGNO,a.ADMIT_DATE,b.patientname,b.age,b.doctorname,b.gender,c.room_no,c.BED_NO from ip_pat_admit a,patientregister b,ip_pat_bed c where a.PAT_REGNO=b.registerno and a.PAT_NO=c.PAT_NO and  a.PAT_NO='$patno'";
$k1=mysqli_query($link,$x) or die(mysqli_error($link));
$k2=mysqli_fetch_array($k1);
$ADMIT_DATE=$k2['ADMIT_DATE'];
$mrno = $k2['PAT_REGNO'];
//$admitdate = date('d-m-Y',strtotime($k2['ADMIT_DATE']));
	$age = $k2['age'];
$gender = $k2['gender'];
$docname = $k2['doctorname'];
$PAT_REGNO=$k2['PAT_REGNO'];
$patname = $k2['patientname'];
