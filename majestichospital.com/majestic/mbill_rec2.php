...
<tr><td colspan="2"> <h2 align="center" style="font-size:18px;"><b><u>Lab Bill</u></b></h2></td></tr>
	...
	<?php
			...
			$sql= mysql_query("select  b.mrno,b.BillDate,b.phoneno,b.PatientName,b.Age,b.Sex,b.DoctorName,b.conce_type,b.ptype,b1.Total,b1.Discount,b1.NetAmount,b1.PaidAmount,b1.BalanceAmount,b1.time from mbill b,mbill1 b1 where b.BillNO=b1.BillNO and b.BillNO='$bno'");
			if($sql)
			{
  ...
  <tr>
         ...
         <tr>
		  ...
		  <tr>
			...
			<table align="center" width="100%" style="border-top:1px solid #000000;border-bottom:1px solid #000000;" cellpadding="0" cellspacing="0">
				<tr >
					<td width="70%" style="padding-left:50px;font-size:16px;" align="left" ><b><u>Test Name</u></b></td>
					<td align="left" ><b><u>Amount</u></b></td>
					
				</tr>
				
			<?php	
				$sql1=mysql_query("SELECT TestName,Amount FROM mbill WHERE BillNO = '$bno'");
				if($sql1){
	...
	<tr>
          <td height="100" colspan="3" align="center"><input type="button" value="Print" id="prnt" class="butt" onclick="prnt();"/> <input type="button" value="Close" id="cls" class="butt" onclick="self.location='manual_lab_bill.php'"/></td>
      </tr>
