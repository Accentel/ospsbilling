...
<hr/>
<h3 align="center">Nursing Chat</h3>
  
<table border="1" align="center"  width="100%" cellpadding="0" cellspacing="0" style=text-align:"center">
     <tr>
         <th rowspan="2" style="width:20px;">S.No</th>
         <th rowspan="2">Name of Drug</th>
		 <th rowspan="2">Dose</th>
         <th rowspan="2">Route</th>
         <th colspan="3">Timmings</th>
    ...
    <?php 
	$rs="select * from nursechart where mrno='$registerno'";
...
<td><?php echo $ts['date1']; ?></td>
<td><?php echo $ts['dose']; ?></td>
<td><?php echo $ts['frequency']; ?></td>
