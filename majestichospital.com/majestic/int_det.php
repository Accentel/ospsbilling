...
<?php 
			 ...
			 //$n=$_REQUEST['name'];
			  $r=$_REQUEST['reg'];
					...
					$s="SELECT a.id,a.mrno,b.patientname,c.ADMIT_DATE,b.age,b.gender FROM `caseshhet_initial1` a,patientregister b,`ip_pat_admit` c 
					where a.mrno=b.registerno and c.PAT_REGNO=b.registerno and a.mrno=c.PAT_REGNO and a.mrno='$r' order by a.id desc";
             ...
             <td style="text-align:center;"><a href="edit_pat_det1.php?id=<?php echo $id?>"><img src="images/edit.gif" /></a></td><!--<td style="text-align:center;">-->
             ...
             <?php }$i++;}
				 ...
				 $s="SELECT a.id,a.mrno,b.patientname,c.ADMIT_DATE,b.age,b.gender FROM `caseshhet_initial1` a,patientregister b,`ip_pat_admit` c 
					where a.mrno=b.registerno and c.PAT_REGNO=b.registerno and a.mrno=c.PAT_REGNO order by a.id desc";
				$sq=mysqli_query($link,$s)or die(mysqli_error($link));
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<td width="25" align="right"><?php if (!($pagecount == 0)) { ?><a href="int_det.php?next=0" ><?php } ?><img src="images/first.gif" title="First" alt="First" width="16" height="14" border="0"/></a></td>
		<td width="10">&nbsp;</td>
	   
		<td width="25" align="right"><?php if (!($pagecount == 0)) { ?>
			  <a  href="int_det.php?next=<?php echo ($pagecount - 1) ?>"><?php } ?><img src="images/previous.gif" title="Previous" alt="Previous" width="16" height="14" border="0"/></a></td>
		  <td width="10">&nbsp;</td>
	  
		<td width="25" align="right"><?php if ($rowscounts > 0) { ?>
			  <a href="int_det.php?next=<?php echo ($pagecount + 1) ?>"><?php } ?><img src="images/next.gif" title="Next" alt="Next" width="16" height="14" border="0"/></a></td>
		<td width="10">&nbsp;</td>
		<td width="25" align="right"><?php if ($rowscounts > 0) { ?><a href="int_det.php?next=<?php echo (($records - 1) / $nd) ?> >  <?php } ?><img src="images/last.gif" title="Last" alt="Last" width="16" height="14" border="0"/></a></td>
	  </tr>
	</table>
	<table>
	<?php if ($rowscounts == 0) { ?>
