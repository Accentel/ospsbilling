			...
			<table width="100%" border="0" cellpadding="4" cellspacing="0">
					...
					<table width="100%" id="TABLE1">
					  <thead>
                       ...
                       <?php
					   $p="select a.tname,a.date1,a.mrno,b.TestName,b.Amount    from opdigitallab a,testdetails b where a.tname=b.TestName and a.mrno='$id' and a.date1='$d'";
					...
					$pam=0;
					   while($r=mysql_fetch_array($result)){
					    ...
					    ?>
					   <tr>
					   <td ><input type="text" class="text" name="tname[]"  id="cname1" value="<?php echo $r['tname'] ?>" readonly="readonly"  required/></td>
