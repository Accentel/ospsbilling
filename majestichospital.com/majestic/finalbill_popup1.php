...
//$sql3=mysqli_query("select sum(amount_pay+concession_amt),sum(concession_amt) from 
...
?>
<?php
echo $data="|".$emp_id."|".$patname."|".$regno."|".$age."|".$gender."|".$addr1."|".$doctorname."|".$rel_type."|".$gaurdianname."|".$phoneno."|".$admitdate."|".$roomrent21."|".$maintfree21."|".$nursefee21."|".$days2."|".$days3."|".$invgfee."|".$invgfee1."|".$invgfee2."|".$adv_amt."|".$t."|".$t1."|".$pkg_type."|".$pkg_amount."|".$bal."|".$BED_NO."|".$room_no;
//.$nursefee2."|".$icu."|";
