                      ...
                      <tbody>
						  ...
						  <?php
						   ...
						   <tr>
                              ...
                              <td><a href="edit_testdept.php?dcode=<?php echo $row['deptcode'] ?>"><img src="images/edit.gif"/></a></td>
							  <td><a onclick="return confirm('Are you sure you want to delete this item?');" href="delete_testdept.php?dcode=<?php echo $row['deptcode'] ?>"><img src="images/Icon_Delete.png" height="18"/></a></td>
                          </tr>
						 <?php } } } } ?>
						 </tbody>	
				</table>
