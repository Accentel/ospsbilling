...
<h1 style="color:red;" align="center">CASE SHEET</h1>
...
MRNO:<span id="regno" class="casesheet">
        ...
        <td valign="top"  align="center"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
			...
			<ul>
				...
				<li><a href="#tabs-6" style="display:none">IP Room Transfers</a></li>
				<li><a href="#tabs-7" style="display:none">Discharge Summary</a></li>
				<li><a href="#tabs-8" >Diagnostics</a></li>
			...
			<div id="tabs-6" style="display:none">  <?php include("Paient_Room_Transfer.php"); ?>                
                   </div>
			 <div id="tabs-7" style="display:none">  <?php include("Discharge_Summary.php"); ?>                  
                   </div>
			  <div id="tabs-8">  <?php include("HMS_Diagnostics.php") ?>                       
                   </div>
