            ...
            <tr>
                <td>
                    ...
                    // $pp="select distinct BillNO,BillDate,PatientName,NetAmount,PaidAmount,BalanceAmount from bill where BillDate between '$sdate1' and '$edate1'";
					 $p="select distinct a.registerno,a.patientname,b.ADMIT_DATE,a.age,a.gender,a.phoneno,b.PAT_NO,b.DIS_STATUS,b.BILL_STATUS  from patientregister a ,ip_pat_admit b where b.ADMIT_DATE between '$sdate1' and '$edate1' and    a.registerno=b.PAT_REGNO and b.DIS_STATUS='ADMITTED'  order by a.registerno asc";
