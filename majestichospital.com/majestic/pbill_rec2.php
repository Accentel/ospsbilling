...
<tr><td colspan="2"> <h2 align="center" style="font-size:18px;"><b><u> IP Final Bill</u></b></h2></td></tr>
  </THEAD>
	<?php
			include("config.php");

			$bno = $_REQUEST['bno'];
			$sql= mysqli_query($link,"select * from pfinalbill where id='$bno' ")or die(mysqli_error($link));
			...
			if($sql)
			{
				...
				$pay = $row['pay'];
				$rbal = $row['rbal'];
	$tu=mysqli_query($link,"select * from patientregister where registerno='$mrno'") or die(mysqli_error($link));
	$td=mysqli_fetch_array($tu);
	$phoneno=$td['phoneno'];
			}		
...
$number = $pay;
 ...
 ?> 
  ...
  <tr>
    <td colspan="2" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		<table width="100%" border="0" align="center" style="font-size:13px;" cellpadding="0" cellspacing="0" >
         ...
         <tr>
		  ...
		  <tr>
			...
			<table align="center" width="100%" style="border-top:1px solid #000000;border-bottom:1px solid #000000;font-size:13px;" cellpadding="0" cellspacing="0">
				<tr >
					<td width="20%" style="padding-left:50px;font-size:13px;" align="left" ><b><u>S No</u></b></td>
					<td width="30%" style="padding-left:50px;font-size:13px;" align="left" ><b><u>Date</u></b></td>
					<td width="30%" style="padding-left:50px;font-size:13px;" align="left" ><b><u>Bill No</u></b></td>
					<td align="left" ><b><u>Amount</u></b></td>
					
				</tr>
				
			<?php	
				$sql1=mysqli_query($link,"SELECT * FROM pfinalbill1 WHERE id1 = '$bno'")or die(mysqli_error($link));
				if($sql1){
					$i=1;
				...
				?>	
				<tr>
				<td style="padding-left:50px;" align="left"><?php echo $i ?></td>
				<td style="padding-left:50px;" align="left"><?php echo $row1['BillDate'] ?></td>
				<td style="padding-left:50px;" align="left"><?php echo $row1['BillNO'] ?></td>
				<td  align="left"><b><?php echo number_format($row1['netamount'],2) ?></b></td>
				</tr>
		 ...
		 <td style="padding-left:95px;">  <b><?php echo number_format($pptotal,2) ?></b></td>
		 ...
		 <td style="padding-left:112px;">  <b><?php echo number_format($discount,2) ?></b></td>
		 ...
		 <td style="padding-left:72px;">  <b><?php echo number_format($pay,2) ?></b></td>
			 
            </tr>
			<tr>
			 <td></td><td></td>
         <td   align="left">Remaining Balance </td>
		 <td style="padding-left:72px;">  <b><?php echo number_format($rbal,2) ?></b></td>
	...
	<tr>
          <td height="100" colspan="3" align="center"><input type="button" value="Print" id="prnt" class="butt" onclick="prnt();"/> <input type="button" value="Close" id="cls" class="butt" onclick="self.location='ppaypatients.php'"/></td>
      </tr>
