...
echo $q="insert into opbill(BillNO, BillDate, PatientName, Age, Sex, DoctorName,Total,Discount,NetAmount,PaidAmount,BalanceAmount,conce_type,ptype,remarks,user,phoneno,mrno,time,observation,bed,deptart,cnt,paymenttype) values('$bno','$bdate','$pname','$age','$gender','$dname','$total','$disc','$namt','$paid','$bal','$ctype','$ptype','$remarks','$user','$mno','$mrno','$time','$observation','$bed','$department','$cnt','$paymenttype')";
