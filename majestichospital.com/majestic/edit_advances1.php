...
return numName;
	...
	<body onload="return validate(document.myform.ret_rupees.value)">
	...
	<?php
          ...
          <h1 style="color:red;" align="center">EDIT ADVANCE RETURN COLLECTIONS</h1>
<?php
include("config.php");

$advid = $_REQUEST['id'];

$sql1 = mysqli_query($link,"SELECT H.ADV_ID,H.PAT_NO,H.ADV_DATE,H.ADV_AMT,H.PAYMENT_MODE,A.PAT_REGNO,A.ADMIT_DATE,M.patientname,M.age,M.gender,H.VOC_NO,H.card_no,H.adv_ret FROM adv_collection_ret as H,ip_pat_admit as A,patientregister as M WHERE H.PAT_NO=A.PAT_NO AND A.PAT_REGNO=M.registerno AND H.ADV_ID='$advid'")or die(mysqli_error($link));
	 ...
	 document.getElementById("cardtr").style.display="";
          ...
          <tr>
            ...
            <td colspan=""><div align="left">
			 ...
			 <td class="label1"><div align="right">Advance Retuen</div></td>
            <td colspan=""><div align="left">
                <input type="text" name="ret_rupees" id="ret_rupees" value="<?php echo $adv_ret ?>"  class="text"/>
            </div></td>
            </tr>
...
<tr><td colspan="4" align="center"><!--<input type="submit" id="prt" name="submit" value="Save"  class="butt"/>&nbsp;--><input type="button" name="close" id="close" value="Close" class="butt" onClick="window.location.href='advance_collections1.php'"/></td></tr></table>
 </form>         
		       </div>
