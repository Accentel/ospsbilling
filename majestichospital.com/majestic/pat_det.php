...
<div id="conteneur">
	...
	<?php /*?><div id="conteneur">
		...
		<?php
			...
			?><?php */?>
		<div id="centre">
          <h1 style="color:red;" align="center">PATIENT DETAILS</h1>
...
<?php 
			  ...
			  $r=$_REQUEST['reg'];
				...
				if($n != "" && $r != "")
				{
					$sq=mysqli_query($link,"select M.reg_id,A.PAT_REGNO,A.ADMIT_DATE,M.patientname,M.arrival_mode,k.ref_docname,M.age,M.gender from ip_pat_admit as A,patientregister as M,referal_doctor as k WHERE  A.PAT_REGNO=M.registerno and M.patientname = '$n'
					 and M.registerno = '$r' and dis_status not like 'Discharged'  and M.ref_doc=k.refcode order by reg_id desc")or die(mysqli_error($link));
             ...
             <td style="text-align:center;"><a href="edit_pat_det.php?id=<?php echo $rid?>"><img src="images/edit.gif" /></a></td><td style="text-align:center;"><A onclick="card_pop('<?php echo $advid ?>')">
			...
			if($sq){	
             ...
             <td style="text-align:center;"><a href="edit_pat_det.php?id=<?php echo $rid?>"><img src="images/edit.gif" /></a></td><!--<td style="text-align:center;">-->
