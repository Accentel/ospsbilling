...
$().ready(function() {
	...
	<?php /*?><div id="conteneur">
		...
		<?php
			...
			?><?php */?>
		<div id="centre">
          <h1 style="color:red;" align="center">NURSE DUTY</h1>
          
                       <form name="frm" method="post" >
           
                
<?php /*?><table width="70%" style="margin-left:300px;"cellspacing="2">
...
<tr><td width="68" class="label1"><a href="add_nurse.php" title="Add New Record"><img src="images/add1.gif"></a></td></tr>
</table>
<table width="100%" cellpadding="0" cellspacing="0" border="1" id="expense_table" style="font-size:14px;">
<tr height="25px"><TH>S.NO.</TH><TH>NURSE NAME</TH>
<th>NURSE MOBILE</th><TH>EDIT</TH><!--<TH>REPORT</TH>--></tr>
<?php 
			  include("config.php");
             ...
             <?php }$i++;}
				 ...
				 //from ip_pat_admit as A,patientregister as M WHERE  A.PAT_REGNO=M.registerno and dis_status not like 'Discharged' order by reg_id desc";
				  $s="SELECT a.id,a.mobile,b.EMP_CODE,b.EMP_NAME FROM `nurs_duty` a,hr_emp b 
					where b.EMP_CODE=a.name  order by a.id desc";
				$sq=mysqli_query($link,$s)or die(mysqli_error($link));
			...
			if($sq){	
             ...
             <td style="text-align:center;"><a href="edit_nurse.php?id=<?php echo $id?>"><img src="images/edit.gif" /></a></td><!--<td style="text-align:center;">-->
