...
<script>
	...
	<div id="conteneur container">
		 ...
		 <div id="centre" class="table-responsive" style="height:auto;">
          ...
          width:auto;">
          <form name="form" method="post" action="sales_excel.php">
		...
		<!--	<option value="Lotus Hospital">Lotus Hospital</option>
          ...
          <tr height="50px">
          <td colspan="2" align="center"><input type="submit" name="submit" value="Report" class="butt"/> <input type="button" name="but" value="Close" class="butt" onclick="window.location.href='home.php'"/></td>
