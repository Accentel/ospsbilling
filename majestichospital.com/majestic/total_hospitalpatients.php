            ...
            <tr>
                <td>
                    <table cellpadding="4" cellspacing="0" width="100%" border="1">
						...
						$qry=mysqli_query($link,"select distinct a.registerno,a.gender,a.tokenno,a.patientname,a.pat_type,a.age,a.phoneno,a.ref_doc,a.date,b.ref_docname,b.refcode from patientregister a,referal_doctor b where a.ref_doc=b.refcode and a.date between '$sdate1' and '$edate1' order by a.registerno asc")or die(mysqli_error($link));
						if($qry){
						$i=0;
