...
document.getElementById("rbal").value=rbal;
	...
	<div id="conteneur">
		...
		<?php
		$q=$_REQUEST['id'];
		$sql="select *  FROM final_bill WHERE BILL_NO = '$q' ";
...
?>
          <div align="center" style="font-size:20px;color:red;font-weight:bold;margin-bottom:20px;">Final Due Bill</div>
		  <form name="frm" method="post" action="insert_due_finalbill.php">
		 ...
		 <div align="center"><input type="submit" name="submit" value="Save" Class="butt"/> <input type="button" value="Close" Class="butt" onclick="window.location.href='final_bill.php'"/></div>
