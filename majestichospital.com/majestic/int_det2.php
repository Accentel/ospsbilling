...
<?php /*?>	<div id="conteneur">
		...
		<?php
			...
			?><?php */?>
		<div id="centre">
          <h1 style="color:red;" align="center">CLINICAL FINDINGS</h1>
...
<tr><td width="68" class="label1"><a href="add_clinic.php" title="Add New Record"><img src="images/add1.gif"></a></td></tr>
</table>
...
<?php 
			 ...
			 //$n=$_REQUEST['name'];
			  $r=$_REQUEST['reg'];
					...
					$s="SELECT a.id,a.mrnum,b.patientname,c.ADMIT_DATE,b.age,b.gender FROM `casesheet_clicnic` a,patientregister b,`ip_pat_admit` c 
             ...
             <td style="text-align:center;"><a href="edit_clinic.php?id=<?php echo $id?>"><img src="images/edit.gif" /></a></td><!--<td style="text-align:center;">-->
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<td width="25" align="right"><?php if (!($pagecount == 0)) { ?><a href="int_det2.php?next=0" ><?php } ?><img src="images/first.gif" title="First" alt="First" width="16" height="14" border="0"/></a></td>
		<td width="10">&nbsp;</td>
	   
		<td width="25" align="right"><?php if (!($pagecount == 0)) { ?>
			  <a  href="int_det2.php?next=<?php echo ($pagecount - 1) ?>"><?php } ?><img src="images/previous.gif" title="Previous" alt="Previous" width="16" height="14" border="0"/></a></td>
		  <td width="10">&nbsp;</td>
	  
		<td width="25" align="right"><?php if ($rowscounts > 0) { ?>
			  <a href="int_det2.php?next=<?php echo ($pagecount + 1) ?>"><?php } ?><img src="images/next.gif" title="Next" alt="Next" width="16" height="14" border="0"/></a></td>
		<td width="10">&nbsp;</td>
		<td width="25" align="right"><?php if ($rowscounts > 0) { ?><a href="int_det2.php?next=<?php echo (($records - 1) / $nd) ?> >  <?php } ?><img src="images/last.gif" title="Last" alt="Last" width="16" height="14" border="0"/></a></td>
	  </tr>
	</table>
	<table>
	<?php if ($rowscounts == 0) { ?>
