...
$tot = $_POST['price'];
$paid1 = ($paid+$cdue);
mysql_query("insert into madv_collection(PAT_NO,ADV_DATE,ADV_AMT,CURRENTDATE,AUTH_BY)values('$pno','$bdate1','$cdue',now(),'$user')");
$sql1 = mysql_query("update manual_bill set totpaid='$paid1',totdue='$rbal' where PatientNo='$pno' and PatientMRNo='$mrno'");
