		...
		<div id="centre" style="height:auto;">
          ...
          <table width="100%" border="0" cellspacing="5" cellpadding="2">
              <tr>
                ...
                <td  align="left"><input name="supcode" type="text" required="required" class="text"  onclick="window.open('purchase_inv_popup.php','mypatwindow','width=500,height=500,toolbar=no,resizable=yes,menubar=no,scrollbar=yes')" id="supcode"/></td>
 ...
 if(val=='B')
   ...
   element.style.display='none';
				...
				<tr>
				  ...
				  <td align="left"><select name="ptype" style="width:230px;height:22px;" onchange='CheckColors(this.value);'>
                  ...
                  <td align="left"><input name="invdate" type="text" class="tcal" id="invdate" value="<?php echo date('Y-m-d'); ?>" readonly="readonly"/>
				...
				<table>
				<tr>
				<td><input type="text" name="bankname" id=""  placeholder="Enter Bank Namee" /></td></tr><tr>
				<td><input type="text" name="chequeno" id=""  placeholder="Enter Cheque No"/></td>
				</tr>
				<tr>
				<td> <input name="date3" type="text" class="tcal" id="date3" value="<?php echo date('Y-m-d'); ?>" readonly="readonly"/></td>
				</tr>
				</table>
				</div></td>
				  <td class="label"><div align="right">Received Date<span class="style2">*</span>:</div></td>
				  <td><div align="left">
                      <input name="recdate" type="text" class="tcal" id="recdate" value="<?php echo date('Y-m-d'); ?>" readonly="readonly"/>
                  </div>
				  </td>
				</tr>
...
<table width="100%" >
              	   ...
              	   <tr>
              	   <td width="15%" class="label1">5% VAT: </td>
				   ...
				   <tr>
              	   ...
              	   <td align="left"><input name="disc" type="text" class="textbox" id="disc" size="15" value="0" onkeyup="javascript:nettotal()"/></td>
            	   </tr>
              	 <tr>
              	   ...
              	   <td class="label">&nbsp;</td>
              	   <td class="label">&nbsp;</td>
              	   <td class="label1">ADD VAT: </td>
              	   <td align="left"><input name="vatadd" type="text" class="textbox" id="vatadd" size="15"/></td>
            	   </tr>
              	 <tr>
                   <td colspan="5" class="label1">Net PAYABLE:</td>
              	   <td align="left"><input name="nettot" type="text" required="required" class="textbox" id="nettot" size="15" onclick="javascript:nettotal()"/></td>
              	 </tr>
 <tr>
 ...
 <tr>
                   <td colspan="5" class="label1">Total Amount:</td>
              	   <td align="left"><input name="gtot" type="text" class="textbox" id="gtot" size="15" onclick="javascript:adjttotal()"/></td>
              	 </tr>
<script>
function adjttotal(){
var sum=0;
