...
str2=document.getElementById("HSN").value;
	//alert("1"+1);
//	alert(str2)
	xmlHttp=GetXmlHttpObject();
	if (xmlHttp==null)
...
url=url+"?pname="+str+"&rowid="+str1+"&btype1="+str2+"&btype1="+str2+";
//alert("url"+url);
	...
	{ 
		...
		document.getElementById("bal"+str).value=strar[1];
			 ...
			 // document.getElementById("pcode"+str).value=strar[5];
			  ...
			  document.getElementById("HSN"+str).value=strar[3];
			...
			/* document.getElementById("bal"+str).value=strar[1];
			  ...
			  document.getElementById("pcode"+str).value=strar[5];
			   ...
			   document.getElementById("vat"+str).value=strar[3];
			  document.getElementById("sqty"+str).focus();
			*/
	}
}
...
echo "</datalist>";?>
								 ...
								 <?php /*?>  <select name="pname1" id="pname1" onblur="showBatch(this.value,1)" style="width:150px;">
								  ...
								  <?php $sq=mysqli_query("select distinct product_name from phr_purinv_dtl");
								  while($row=mysqli_fetch_array($sq)){$res=$row['product_name'];?>
								  ...
								  <td><input  type='text' name='HSN1' id='HSN1' class='textbox1' size='7'/></td>
...
NotPaid</td>-->
                          ...
                          <tr>
							...
							<tr id="cashtr" style="display:''">
							  ...
							  <td align="left">
                              <input name="nettotal" type="text" class="text" id="nettotal" readonly="readonly"/></td>
							  </tr>
