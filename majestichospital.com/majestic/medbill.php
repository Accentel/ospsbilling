...
if($customer_type == "c"){
	...
	$ss=mysqli_query($link,$a)or die(mysqli_error($link));
 }
 ...
 $rest = substr("$custname", 0, 3); 
				...
				$res=mysqli_query($link,"Select a.patientname,a.registerno from patientregister a,`op_pat_dlt` b where
				 a.registerno=b.PAT_REGNO and a.registerno='$custname'")or die(mysqli_error($link));
					...
					//$ctype="In Patient";
				$res=mysqli_query($link,"Select a.patientname,a.registerno from patientregister a,`ip_pat_admit` b where a.registerno=b.PAT_REGNO and b.pat_no='$custname'")or die(mysqli_error($link));
				}
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
		...
		<tr>
          ...
          <tr>
            <td colspan="12"><table width="100%" border="0" align="center" cellpadding="8" cellspacing="20" style="border:1px solid #999999;background:#FFFFFF" "column-count: 9;" "column-gap:50px">
              <tr class="label1">
			...
			// $sa="select a.product_code,b.product_name,b.HSN,b.batch_no,b.mfg_date,a.u_qty,a.u_rate,a.value,c.discount,c.total,a.disc,a.total,d.TYPE,a.gst,a.total as tt from
			// phr_salent_dtl as a,
			//  phr_purinv_dtl as b,phr_salent_mast as c,`phr_prddetails_mast` as d where
//a.inv_id=b.inv_id and a.lr_no=c.lr_no and a.lr_no='$lr_id'

			 // a.inv_id=b.inv_id and a.lr_no=c.lr_no and a.lr_no='$lr_id' and b.inv_id=d.id ";
			
$sa="select a.product_code,b.PRODUCT_NAME,b.BATCH_NO,b.mfg_date,b.EXP_DATE,a.u_qty,a.u_rate,a.value,balance_qty,a.inv_id,c.discount,c.total,a.disc,a.total as th,c.spl_dis,a.gst,a.total as tt,b.HSN
from phr_salent_dtl as a,phr_purinv_dtl as b,phr_salent_mast as c where a.inv_id=b.inv_id and a.lr_no=c.lr_no and a.lr_no='$lr_id'";
		...
		<td align="left"><?php echo $row1[5] ?></td>
                ...
                <td align="left"><?php echo $row1['th'] ?></td>
		<?php /*?><td align="left"><?php echo $row1[7] ?></td><?php */?>
				...
				echo $gst_amt=$gst_amt1/2;?>(<?php echo $gst/2?>%)
				 ...
				 <td align="left"><?php echo $row1['HSN'] ?></td>
				 <td align="left"><?php echo $row1[18] ?></td>
          ...
          <tr><td colspan="2">
              ...
              <strong >Total :</strong> <?php echo $tot+$spl_dis ?>
               
               </td>
			   <td><strong > &nbsp;&nbsp;&nbsp;&nbsp; Discount : </strong><?php echo $spl_dis;?></td>
			   </tr>
