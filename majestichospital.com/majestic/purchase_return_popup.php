...
<?php 
			  ...
			  $sq = mysqli_query($link,"select distinct a.suppl_code,b.suppl_name,b.addr1,b.city from phr_purinv_mast a,phr_supplier_mast b where a.suppl_code=b.suppl_code and b.suppl_name = '$n'")or die(mysqli_error($link));
			 ...
			 $sq = mysqli_query($link,"select distinct a.suppl_code,b.suppl_name,b.addr1,b.city from phr_purinv_mast a,phr_supplier_mast b where a.suppl_code=b.suppl_code ")or die(mysqli_error($link));
