...
-->
           ...
           <td>Tot</td><td>Cash</td><td>Card</td></tr>
            ...
            <?php /*?><tr><td class="krk">Morning Shift</td><td>
             <?php $as=mysqli_query("select sum(amount) as op from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='Patient Register'");
            ...
            <td>
             ...
             <?php $as=mysqli_query("select sum(amount) as op from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='Patient Register' and pay_type='Cash'");
			$k1=mysqli_fetch_array($as);
			echo $cmop=$k1['op'];
			?>
            ...
            <td>
             <?php $as=mysqli_query("select sum(amount) as op from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='Patient Register' and pay_type='Card'");
			$k1=mysqli_fetch_array($as);
			echo $cdmop=$k1['op'];
			?>
            </td>
            ...
            <td>
             <?php $as=mysqli_query("select sum(amount) as ip from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='In Patient'");
			$k1=mysqli_fetch_array($as);
			echo $ip=$k1['ip'];
			?>
            ...
            <td>
             <?php $as=mysqli_query("select sum(amount) as ip from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='In Patient' and pay_type='Cash'");
			$k1=mysqli_fetch_array($as);
			echo $cip=$k1['ip'];
			?>
            ...
            <td>
             <?php $as=mysqli_query("select sum(amount) as ip from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='In Patient' and pay_type='Card'");
			$k1=mysqli_fetch_array($as);
			echo $cdip=$k1['ip'];
			?>
            ...
            <td>
             <?php $as=mysqli_query("select sum(amount) as mlab from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='Lab'");
			$k1=mysqli_fetch_array($as);
			echo $mlab=$k1['mlab'];
			?>
             ...
             <td>
             <?php $as=mysqli_query("select sum(amount) as mlab from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='Lab' and pay_type='Cash'");
			$k1=mysqli_fetch_array($as);
			echo $cmlab=$k1['mlab'];
			?>
             ...
             <td>
             <?php $as=mysqli_query("select sum(amount) as mlab from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='Lab' and pay_type='Card'");
			$k1=mysqli_fetch_array($as);
			echo $cdmlab=$k1['mlab'];
			?>
            ...
            <td>
             <?php $as=mysqli_query("select sum(amount) as adv from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='Advance Collection'");
			$k1=mysqli_fetch_array($as);
			echo $adv=$k1['adv'];
			?>
             ...
             <td>
             <?php $as=mysqli_query("select sum(amount) as adv from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='Advance Collection' and pay_type='Cash'");
			$k1=mysqli_fetch_array($as);
			echo $cadv=$k1['adv'];
			?>
             ...
             <td>
             <?php $as=mysqli_query("select sum(amount) as adv from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='Advance Collection' and pay_type='Card'");
			$k1=mysqli_fetch_array($as);
			echo $cdadv=$k1['adv'];
			?>
            ...
            <td>
             <?php $as=mysqli_query("select sum(amount) as pes from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='Package Extra Service'");
			$k1=mysqli_fetch_array($as);
			echo $pes=$k1['pes'];
			?>
             ...
             <td>
             <?php $as=mysqli_query("select sum(amount) as pes from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='Package Extra Service'   and pay_type='Cash'");
			$k1=mysqli_fetch_array($as);
			echo $cpes=$k1['pes'];
			?>
             ...
             <td>
             <?php $as=mysqli_query("select sum(amount) as pes from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='Package Extra Service'   and pay_type='Card'");
			$k1=mysqli_fetch_array($as);
			echo $cdpes=$k1['pes'];
			?>
         ...
         <td>
             <?php $as=mysqli_query("select sum(amount) as gcash from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='General CashBill'");
			$k1=mysqli_fetch_array($as);
			echo $gcash=$k1['gcash'];
			?>
             ...
             <td>
             <?php $as=mysqli_query("select sum(amount) as gcash from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='General CashBill' and pay_type='Cash'");
			$k1=mysqli_fetch_array($as);
			...
			?>
             ...
             <td>
             <?php $as=mysqli_query("select sum(amount) as gcash from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='General CashBill' and pay_type='Card'");
			$k1=mysqli_fetch_array($as);
            ...
            <td>
             <?php $as=mysqli_query("select sum(amount) as hs from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='Hospital Service'");
			$k1=mysqli_fetch_array($as);
			echo $hs=$k1['hs'];
			?>
             ...
             <td>
             <?php $as=mysqli_query("select sum(amount) as hs from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='Hospital Service' and pay_type='Cash' ");
			$k1=mysqli_fetch_array($as);
			echo $chs=$k1['hs'];
			?>
             ...
             <td>
             <?php $as=mysqli_query("select sum(amount) as hs from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='Hospital Service' and pay_type='Card'");
			$k1=mysqli_fetch_array($as);
			echo $cdhs=$k1['hs'];
			?>
            ...
            <td>
             <?php $as=mysqli_query("select sum(amount) as fbill from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='Package FinalBill'");
			$k1=mysqli_fetch_array($as);
			echo $fbill=$k1['fbill'];
			?>
             ...
             <td>
             <?php $as=mysqli_query("select sum(amount) as fbill from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='Package FinalBill'  and pay_type='Cash'");
			$k1=mysqli_fetch_array($as);
			...
			?>
             ...
             <td>
             <?php $as=mysqli_query("select sum(amount) as fbill from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='Package FinalBill'  and pay_type='Card'");
			$k1=mysqli_fetch_array($as);
            ...
            $x3=mysqli_query($link,"select distinct recv_by from daily_amount where date(date1)='$sdate1'")or die(mysqli_error($link));
             ...
             <?php $as=mysqli_query($link,"select sum(amount) as eop from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Patient Register'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			echo $eop=$k1['eop'];
			?>
            ...
            <td>
             <?php $as=mysqli_query($link,"select sum(amount) as eop from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Patient Register'  and pay_type='Cash'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			echo $ceop=$k1['eop'];
			?>
            ...
            <td>
             <?php $as=mysqli_query($link,"select sum(amount) as eop from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Patient Register'  and pay_type='Card'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			echo $cdeop=$k1['eop'];
			?>
          ...
          <td>
			 ...
			 $as=mysqli_query($link,$sq2)or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			echo $eip=$k1['eip'];
			?>
             ...
             <td>
             <?php $as=mysqli_query($link,"select sum(amount) as eip from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='In Patient' and pay_type='Cash'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			echo $ceip=$k1['eip'];
			?>
             ...
             <td>
             <?php $as=mysqli_query($link,"select sum(amount) as eip from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='In Patient' and pay_type='Card'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			echo $cdeip=$k1['eip'];
			?>
            ...
            <td>
             <?php $as=mysqli_query($link,"select sum(amount) as elab from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Lab'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			echo $elab2=$k1['elab'];
			
			
			$as1=mysqli_query($link,"select sum(amount) as elab from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Lab Due'")or die(mysqli_error($link));
			$k11=mysqli_fetch_array($as1);
			$elab3=$k11['elab'];
		echo	$elab=$elab2+$elab3;
			
			?>
            
            </td>
             <td>
             <?php $as=mysqli_query($link,"select sum(amount) as elab from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Lab' and pay_type='Cash'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			 $celab2=$k1['elab'];
			
			
			$as10=mysqli_query($link,"select sum(amount) as elab from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Lab Due' and pay_type='Cash'")or die(mysqli_error($link));
			$k111=mysqli_fetch_array($as10);
			 $celab3=$k111['elab'];
		echo	$celab=$celab2+$celab3;
			?>
            
            </td>
             <td>
             <?php $as=mysqli_query($link,"select sum(amount) as elab from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Lab' and pay_type='Card'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			echo $cdelab=$k1['elab'];
			?>
            ...
            <td>
             <?php $as=mysqli_query($link,"select sum(amount) as eadv from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Advance Collection'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			echo $eadv=$k1['eadv'];
			?>
             ...
             <td>
             <?php $as=mysqli_query($link,"select sum(amount) as eadv from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Advance Collection' and pay_type='Cash'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			echo $ceadv=$k1['eadv'];
			?>
             ...
             <td>
             <?php $as=mysqli_query($link,"select sum(amount) as eadv from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Advance Collection' and pay_type='Card'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			echo $cdeadv=$k1['eadv'];
			?>
            ...
            <td>
             <?php $as=mysqli_query($link,"select sum(amount) as epes from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Package Extra Service'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			echo $epes=$k1['epes'];
			?>
             ...
             <td>
             <?php $as=mysqli_query($link,"select sum(amount) as epes from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Package Extra Service' and pay_type='Cash'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			echo $cepes=$k1['epes'];
			?>
             ...
             <td>
             <?php $as=mysqli_query($link,"select sum(amount) as epes from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Package Extra Service'  and pay_type='Card'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			echo $cdepes=$k1['epes'];
			?>
            ...
            <td>
             <?php $as=mysqli_query($link,"select sum(amount) as egcash from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='General CashBill'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			...
			?>
             ...
             <td>
             <?php $as=mysqli_query($link,"select sum(amount) as egcash from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='General CashBill' and pay_type='Cash'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			...
			?>
             ...
             <td>
             <?php $as=mysqli_query("select sum(amount) as egcash from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='General CashBill' and pay_type='Card'");
			$k1=mysqli_fetch_array($as);
            ...
            <td>
             <?php $as=mysqli_query($link,"select sum(amount) as ehs from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Hospital Service'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			echo $ehs=$k1['ehs'];
			?>
             ...
             <td>
             <?php $as=mysqli_query($link,"select sum(amount) as ehs from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Hospital Service' and pay_type='Cash'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			echo $cehs=$k1['ehs'];
			?>
             ...
             <td>
             <?php $as=mysqli_query($link,"select sum(amount) as ehs from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Hospital Service' and pay_type='Card'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			echo $cdehs=$k1['ehs'];
			?>
            ...
            <td>
             <?php $as=mysqli_query($link,"select sum(amount) as efbill from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Package FinalBill'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			...
			?>
             ...
             <td>
             <?php $as=mysqli_query($link,"select sum(amount) as efbill from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Package FinalBill' and pay_type='Cash'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			...
			?>
             ...
             <td>
             <?php $as=mysqli_query($link,"select sum(amount) as efbill from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Package FinalBill' and pay_type='Card'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
           ...
           <?php /*?> <tr><td>M</td>
            <?php $sq=mysqli_query("select b.BillNO from daily_amount a,bill1 b where a.date_time 
			...
			while($rr=mysqli_fetch_array($sq)){
				 ...
				 $qs=mysqli_query("select * from bill where BillNO='$lab_bill_num'");
				 ...
				 $ink=$rkk['Amount'];
				 $ss2=mysqli_query("SELECT * FROM `testdetails` where TestName='$lab' and ltype='out'"); 
				 $rkk2=mysqli_fetch_array($ss2);
				 $outk=$rkk2['Amount'];
				  $ss3=mysqli_query("SELECT * FROM `testdetails` where TestName='$lab' and ltype='X-Ray/Scan'"); 
            ...
            $x3=mysqli_query("select distinct recv_by from daily_amount where date(date1)='$sdate1'");
							while($d=mysqli_fetch_array($x3)){
								$i=1;
								$partic=$d['recv_by'];
			...
			between '$time2' and '$time3' and a.amnt_type='Lab' and a.recv_by='$recv_by' and a.bill_num=b.cnt")or die(mysqli_error($link));
			while($rr1=mysqli_fetch_array($sq1)){
				 $lab_bill_num1=$rr1['BillNO'];
				 $qs1=mysqli_query($link,"select * from bill where BillNO='$lab_bill_num1'")or die(mysqli_error($link));
				 while($re=mysqli_fetch_array($qs1)){
				  $lab1=$re['TestName'];
				  $a1="SELECT * FROM `testdetails` where TestName='$lab1' and ltype='in'";
				 $ssk1=mysqli_query($link,$a1)or die(mysqli_error($link));
				 $rkk=mysqli_fetch_array($ssk1);
				 $ink1=$rkk['Amount'];
				 $ss2=mysqli_query($link,"SELECT * FROM `testdetails` where TestName='$lab1' and ltype='out'")or die(mysqli_error($link));
				 $rkk2=mysqli_fetch_array($ss2);
				 $outk1=$rkk2['Amount'];
				  $ss3=mysqli_query($link,"SELECT * FROM `testdetails` where TestName='$lab1' and ltype='X-Ray/Scan'")or die(mysqli_error($link));
				 $rkk3=mysqli_fetch_array($ss3);
				 $xrayk1=$rkk3['Amount'];
				 $in1=$ink1+$in1;
				 $out1=$outk1+$out1;
		...
		$as=mysqli_query($link,$sss)or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			 $elabkk=$k1['elab'];
			?>
           ...
           <tr> <td>
            ...
            <tr  style=" font-weight:bold;"><td></td><td colspan="2">DR. ZAINAB</td>
            ...
            </td>  <td> <?php $as=mysqli_query("select sum(amount) as mvisit from daily_amount where date_time between '$time' and '$time1'
            ...
            <td> <?php $as=mysqli_query("select sum(amount) as mlab from daily_amount where date_time between '$time' and '$time1' and recv_by='Zeenath' and amnt_type='Lab'");
			$k1=mysqli_fetch_array($as);
			echo $mlab=$k1['mlab'];
			?></td>
            ...
            <?php echo $yx4=$ip_e4+$ad_e4+$pke_e4+$gne_e4+$hsp_e4+$pkg_e4?>
             ...
             <td> <?php $as=mysqli_query($link,"select sum(amount) as evisit from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by'
			  and amnt_type='Patient Register' and doct_name='VISIT'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			...
			echo $ehamt=$r2['ehamt'];?>
             ...
             <td> <?php $as=mysqli_query($link,"select sum(amount) as elab from daily_amount where date_time  between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Lab'")or die(mysqli_error($link));
			$k1=mysqli_fetch_array($as);
			echo $elab=$k1['elab'];
			?></td>
            ...
            <td><?php echo $t2=$op_m2+$op_e2k?></td><td><?php echo $tt2=$y2+$yx2k?></td>
            <td><?php echo $t3=$op_m3+$op_e3k?></td><td><?php echo $tt3=$y3+$yx3k?></td>
            <td><?php echo $t4=$op_m4+$op_e4k?></td><td><?php echo $tt4=$y4+$yx4k?></td>
            ...
            <td><?php echo $net=$t+$t1+$t2+$t3+$t4+$tt+$tt1+$tt2+$tt3+$tt4+$ht+$lt+$vis?></td></tr>
            </table></td></tr>
            
         <tr><td>
		 <table cellpadding="4" cellspacing="0" width="100%" border="1" style="margin-top:10px;"><tr><td>
		 
		 <b>Total Expenses</b></td><td><b>Net Amount</b></td></tr>
<tr><td><?php $s=mysqli_query($link,"SELECT sum(amount) as amt FROM `addexpenses` WHERE bill_date='$sdate1'")or die(mysqli_error($link));
$rx=mysqli_fetch_array($s);	 
            echo $expens=$rx['amt'];?></td><td><?php echo $net-$expens;?></td></tr></table></td></tr>
                        ...
                        <tr>
                           ...
                           <td align="center"><?php  $p=$r['pregister'];
						    if($p>=1){
								echo $p;} else { echo 0;}
						    ?></td>
                           <?php $ss=mysqli_query("select sum(amount) as ip from daily_amount where recv_by='$partic' and amnt_type='In Patient' and date(date1)='$sdate1' group by date(date1)");
                           ...
                           <td align="center"><?php  $ip=$r1['ip'];
						    if($ip>=1){
                              ...
                              <?php $ss=mysqli_query("select sum(amount) as advance from daily_amount where recv_by='$partic' and amnt_type='Advance Collection' and date(date1)='$sdate1' group by date(date1)");
							 $r3=mysqli_fetch_array($ss);?>
                            <td align="center"><?php  $ad=$r3['advance'];
							 if($ad>=1){
								echo $ad;} else { echo 0;}
							 ?></td>
                             <?php $ss=mysqli_query("select sum(amount) as lab from daily_amount where recv_by='$partic' and amnt_type='Lab' and date(date1)='$sdate1' group by date(date1)");
