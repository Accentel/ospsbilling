...
window.onload=GetClock;
	...
	<div id="conteneur">
		...
		<?php 
		$id=$_REQUEST['bno'];
		$m=mysqli_query($link,"select * from opbill where BillNO='$id'") or die(mysqli_error($link));
		...
		?>
          <div align="center" style="font-size:20px;color:red;font-weight:bold;margin-bottom:20px;">Out Patient Discharge Cash Bill</div>
		  <form name="myform" method="post" action="update_opbill.php">
			<table width="100%" border="0" cellpadding="4" cellspacing="0">
					...
					<table width="100%" id="TABLE1">
					  <thead>
                       ...
                       <?php 
						$sql2 = mysqli_query($link,"select * from opbill1 where BillNO = '$id'")or die(mysqli_error($link));
						if($sql2){
