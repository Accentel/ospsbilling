...
<tr><td colspan="2"> <h2 align="center" style="font-size:18px;"><b><u>Extra Package Services Bill<!--Observation Patient Discharge Cash Bill--></u></b></h2></td></tr>
  </THEAD>
	<?php
			include("config.php");

			$bno = $_REQUEST['bno'];
			$qr="select a.BillDate,a.PatientName,a.Age,a.mrno,a.Sex,a.DoctorName,a.Total,a.Discount,a.NetAmount,a.PaidAmount,a.BalanceAmount,a.conce_type,a.ptype,a.phoneno,a.time,a.deptart,a.cnt,b.registerdate,b.registerno,b.auth_by from packagebill a,patientregister b where b.registerno=a.mrno and a. BillNO='$bno'";
...
$number = $tot;
 ...
 ?> 
  ...
  <tr>
		...
		<table width="100%" border="0" align="center" style="font-size:13px;" cellpadding="0" cellspacing="0" >
         ...
         <tr>
		  ...
		  <tr>
			...
			<?php	
				$sql1=mysqli_query($link,"SELECT purpose,Amount FROM packagebill1 WHERE BillNO = '$bno'");
				if($sql1){
	...
	<tr>
          <td height="100" colspan="3" align="center"><input type="button" value="Print" id="prnt" class="butt" onclick="prnt();"/> <input type="button" value="Close" id="cls" class="butt" onclick="self.location='view_packagebill.php'"/></td>
      </tr>
